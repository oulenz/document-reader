...
def identify_template(image_path: str, mock_document_type_name: str, path_dict_path: str) -> None:
...
if __name__ == "__main__":
    ...
    identify_template(args.image_path, args.mock_document_type_name, args.path_dict_path)